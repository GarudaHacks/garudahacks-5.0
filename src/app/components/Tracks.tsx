        ...
        <main className="w-full h">
            ...
            <div className="flex w-10/12 lg:w-[1040px] flex-col items-center justify-between mx-auto mb-20 mt-5 lg:flex-row">
                <div className="flex flex-col w-full mb-5 lg:mb-0 lg:w-[40%] mx-auto lg:ml-0 mt-3 px-5 pt-4 pb-6 rounded-md border border-white">
                    ...
                    <p className="text-white text-left">Despite life's obstacles, there are always those who lend a hand when it matters most. We can embody this spirit by extending a helping hand to individuals, including those who have been through the justice system, in finding their footing once again.</p>
                </div>
                <div className="flex flex-col w-full lg:w-[40%] mx-auto lg:mr-0 mt-3 px-5 pt-4 pb-6 rounded-md border border-white">
                    ...
                    <p className="text-white text-left">Leadership, innovation, and determination for working for a common goal are all characteristics vital towards achieving a better product. By connecting with those in nearby communities, your ideas can drive major change and improvement.</p>
